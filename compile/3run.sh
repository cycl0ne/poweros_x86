...
#qemu_cmdline="qemu-system-x86_64 -smp sockets=1,cores=2,threads=2 -serial stdio -nographic -monitor telnet:127.0.0.1:1234,server,nowait"   #pty   -monitor stdio "
qemu_cmdline="qemu-system-i386 -smp sockets=1,cores=2,threads=2 -serial stdio -nographic -monitor telnet:127.0.0.1:1234,server,nowait"   #pty   -monitor stdio "
