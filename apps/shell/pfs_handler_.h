...
typedef struct INode
{
	...
	BLOCKNUM	direct[MAX_DIRECT_BLOCKS]; //8 *NUM (256)
	BLOCKNUM	indirect[MAX_INDIRECT_BLOCKS];		// (256)
	BLOCKNUM	indirect2[MAX_INDIRECT2_BLOCKS];		//(256)
	BLOCKNUM	indirect3[MAX_INDIRECT3_BLOCKS];		//128
	UINT64		size;			//8
} INode, *pINode;
