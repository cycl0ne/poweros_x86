...
STRPTR util_Strchr(STRPTR s, int c);
...
void util_QuickSort(pUtility UtilBase, pList l, pNodeCmpLe le);
STRPTR util_StrDup(pUtility UtilBase, const STRPTR s);
