...
static inline void ALWAYS_INLINE funcname(pSD psd, pBlitParms gc,\
...
/* 32bpp BGRA*/
void convblit_copy_mask_mono_byte_lsb_bgra(pSD psd, pBlitParms gc)
{
...
/* 32bpp BGRA*/
void convblit_copy_mask_mono_word_msb_bgra(pSD psd, pBlitParms gc)
{
...
/* 32bpp BGRA*/
void convblit_copy_mask_mono_byte_msb_bgra(pSD psd, pBlitParms gc)
{
 ...
 */
static inline void ALWAYS_INLINE convblit_blend_mask_alpha_byte(pSD psd, pBlitParms gc,
	int DSZ, int DR, int DG, int DB, int DA, int PORTRAIT)
{
	unsigned char *src, *dst;
	int dsz, dst_pitch;
...
/* 32bpp BGRA*/
void convblit_blend_mask_alpha_byte_bgra(pSD psd, pBlitParms gc)
{
