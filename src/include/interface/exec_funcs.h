...
void RemIntServer(UINT32 intNumber, struct Interrupt *isr);
...
struct Interrupt *SetExcVector(UINT32 excNumber, struct Interrupt *isr);
...
#define Alert(x, y...)			(((void(*)(APTR, UINT32, const char *, ...))	_GETVECADDR(SysBase, 57))(SysBase,x, ##y))
...
#define RemIntServer(x,y)		(((void(*)(APTR, UINT32, struct Interrupt *))		_GETVECADDR(SysBase, 70))(SysBase,x, y))
#define CreateIntServer(a,b,c,d)		(((struct Interrupt *(*)(APTR, const STRPTR, INT8, APTR, APTR))		_GETVECADDR(SysBase, 71))(SysBase,a,b,c,d))

// TODO !!!!!!! REMOVE ADDEXCSERVER !
#define AddExcServer(x,y)		(((void(*)(APTR, UINT32, struct Interrupt *))					_GETVECADDR(SysBase, 72))(SysBase,x, y))
#define SetExcVector(x,y)		(((struct Interrupt *(*)(APTR, UINT32, struct Interrupt *))		_GETVECADDR(SysBase, 73))(SysBase,x, y))
