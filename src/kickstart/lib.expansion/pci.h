/*
*   Copyright © 2004 by Curare. All rights reserved.
*   $Id: pci.h,v 1.1 2004/09/11 16:33:55 cycl0ne Exp $
*
*    NAME
*   pcibase.h - Header File for the PCIBase Structure incl. PCIDevice. 
*
*/
...
struct PCIBus
{
    struct List pci_Node;
    UINT32      PCIDeviceNumber;
    UINT32      PrimaryBus;
    UINT32      SecondaryBus;   
};  
